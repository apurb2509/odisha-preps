      ...
      <footer className="bg-black text-gray-400 py-8 px-6 border-t border-purple-800">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p>📞 +91 63726-11728</p>
            <p>✉️ odishaprpesofficial@gmail.com </p>
            <p>📍 Radha Krishna Nagar, 776/2440, Garage Chhack, near Meenakshi Enclave, Kedar Gouri Vihar, Gouri Nagar, Old Town, Bhubaneswar, Odisha, 751002</p>
